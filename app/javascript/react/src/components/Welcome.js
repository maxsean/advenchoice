  ...
  return(
    <div className='welcome'>
      ...
      <div className='welcome-tile'>
        <p>
          By fire the world was undone. From the heavens a dark and gray shroud engulfed the North.
          Perhaps you have seen it, what lies beyond the Ashen Veil. A murky, forgotten land where the cursed are coralled to mend their ailing souls.
